        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToStripeAccountId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentSlots_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppointmentCauses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    End = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ParentFirstName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ParentLastName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ChildFirstName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    DoctorId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    PatientId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AppointmentCauseId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_AppointmentCauses_AppointmentCauseId",
                        column: x => x.AppointmentCauseId,
                        principalTable: "AppointmentCauses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChatImages_Messages_MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Charge = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_OfferedServices_OfferedServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentCauses_AppointmentId",
                table: "AppointmentCauses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_AppointmentCauseId",
                table: "Appointments",
                column: "AppointmentCauseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_AddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_OfferedServiceId",
                table: "Payments",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AppointmentCauses_Appointments_AppointmentId",
                table: "AppointmentCauses",
                column: "AppointmentId",
                principalTable: "Appointments",
                principalColumn: "Id");

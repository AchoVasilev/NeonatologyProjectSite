...
public static class GlobalConstants
{
    ...
    public const string SuccessfulAppointmentEmailMsgSubject = "Записване на час при д-р Петрова";
    ...
    public static class AccountConstants
    {
        ...
        public const string YearsExperience = "Стаж";
    ...
    public static class NotificationConstants
    {
        ...
        public const int NotificationSkip = 0;
    }
